...
def record_loop(
    ...
    while timestamp < control_time_s:
        ...
        if policy is not None and preprocessor is not None and postprocessor is not None:
            ...
            # Check for episode control events from teleop (e.g. 's' to save, 'r' to rerecord)
            if hasattr(teleop, "get_teleop_events"):
                ...
                elif teleop_events.get(TeleopEvents.TERMINATE_EPISODE, False):
                    events["exit_early"] = True
...
def record(cfg: RecordConfig) -> LeRobotDataset:
    ...
    # Allow teleop to query robot state (e.g. KeyboardEndEffectorTeleop reads TCP for absolute-position actions)
